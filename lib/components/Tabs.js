...
var Tabs = function (_Component) {
    ...
    _createClass(Tabs, [{
        ...
        value: function transformChildren(children, _ref) {
            ...
            var activeLinkStyle = _ref.activeLinkStyle;
            var name = _ref.name;
        ...
        value: function render() {
            var handleSelect = this.props.handleSelect || this.handleSelect.bind(this);
            var selectedTab = this.props.selectedTab || this.state.selectedTab || this.findDefault(this.props.children);
